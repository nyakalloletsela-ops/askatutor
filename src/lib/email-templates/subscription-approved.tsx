  ...
  <Html lang="en" dir="ltr">
    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>
          Hi{name ? `, ${name}` : ""} — your subscription payment of{" "}
          <strong>M{amount ?? 250}</strong> has been approved. You'll appear as a Featured tutor for
          the next 30 days.
        </Text>
        <Button href={`${SITE_URL}/tutors`} style={btn}>
          View your profile
        </Button>
