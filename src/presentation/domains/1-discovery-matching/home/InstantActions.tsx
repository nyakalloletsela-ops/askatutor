...
const actions = [
  {
    ...
    desc: "Get help with something you are stuck on.",
    to: "/auth" as const,
    label: "Get help",
  },
  {
    ...
    desc: "Find a tutor for your subject, level and goal.",
    to: "/tutors" as const,
    label: "Find a tutor",
  },
  {
    ...
    desc: "Build understanding with practice and learning tools.",
    to: "/auth" as const,
      ...
      <div className="grid gap-3 md:grid-cols-3">
        {actions.map((action) => (
          <Link
            key={action.title}
            to={action.to}
            className="group rounded-2xl border border-border/60 bg-card p-5 transition hover:-translate-y-0.5 hover:border-primary/50 hover:shadow-md"
          >
