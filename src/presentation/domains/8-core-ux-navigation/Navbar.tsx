      ...
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4">
        ...
        <nav className="hidden items-center gap-1 md:flex" aria-label="Primary">
          ...
          <Button
            asChild
            size="sm"
            className="ml-2 rounded-xl bg-aurora text-white hover:opacity-90"
          >
          ...
          <button
            ...
            className="ml-1 rounded-md p-2 text-foreground/70 hover:bg-accent hover:text-foreground"
          >
          ...
          {isAdmin && (
            <Link
              ...
              className="relative rounded-md p-2 text-foreground/70 hover:bg-accent"
            >
      ...
      {open && (
        <div className="border-t border-border/60 bg-background/95 backdrop-blur md:hidden">
          <div className="flex flex-col gap-1 px-4 py-3">
            {links}
            <Button asChild size="sm" className="mt-2 justify-start bg-aurora text-white">
              <Link to={user ? "/dashboard" : "/auth"} onClick={close}>
                {user ? "Continue Learning" : "Start Learning"}
              </Link>
            </Button>
            {user && (
