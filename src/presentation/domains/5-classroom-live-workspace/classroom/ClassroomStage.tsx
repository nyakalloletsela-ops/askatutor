import { Whiteboard } from "../whiteboard/canvas/Whiteboard";
import { LorddaLab } from "../LorddaLab";
  ...
  return (
    <div className="relative flex h-full min-h-0 flex-col">
      ...
      <div className="relative min-h-0 flex-1">
        <div
          className={`absolute inset-0 ${stage === "whiteboard" ? "" : "invisible pointer-events-none"}`}
        >
          <Whiteboard
            roomId={roomId}
            userId={userId}
