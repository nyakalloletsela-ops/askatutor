...
export function ProcessView({ schema, playing, resetKey, timeScale, onSelectObject }: Props) {
  ...
  if (steps.length === 0) {
    return (
      <div className="flex h-full items-center justify-center text-white/50">No process steps</div>
    );
  }
    ...
    <div className="flex h-full w-full flex-col bg-[#0b1020] p-4">
            ...
            >
              <div
                ...
                style={{
                  ...
                  boxShadow: active ? `0 0 40px ${o.color ?? "#fff"}` : "none",
                }}
              >
      ...
      <div className="mt-6 rounded-2xl border border-white/10 bg-black/50 p-4 backdrop-blur">
        ...
        <div className="mt-3 h-1 w-full overflow-hidden rounded-full bg-white/10">
          <div
            className="h-full bg-violet-400 transition-[width] duration-200"
