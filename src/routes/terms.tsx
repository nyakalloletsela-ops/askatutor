    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="mx-auto max-w-4xl px-4 py-10 sm:py-14">
        <article className="prose prose-slate max-w-none dark:prose-invert">
          ...
          <p>
            By using AskATutorLive, you agree to use the platform lawfully, responsibly and in a
            way that does not interfere with other users or the operation and security of the
            service.
          </p>
          ...
          <p>
            ...
            credentials and sessions under your control. Do not impersonate another person or
            create an account using information you are not authorized to use.
          </p>

          <h2>3. Learners and tutors</h2>
          <p>
            Learners are responsible for using tutoring and learning features appropriately.
            Tutors are responsible for providing services professionally, accurately representing
            their qualifications and following applicable platform rules. AskATutorLive may apply
            role and access controls to protect learners, tutors and institutions.
          </p>

          <h2>4. Educational information</h2>
          <p>
            AskATutorLive provides educational and tutoring tools. Platform content, tutor
            guidance and AI-generated information are not a substitute for professional advice
            where professional advice is required. Users should exercise appropriate judgment and
          ...
          <p>
            ...
            attempt to manipulate payment status, entitlements, invoices, subscriptions or
            platform balances.
          </p>
          ...
          <p>
            ...
            users, investigate abuse, enforce these terms, protect the service, or comply with
            legal obligations.
          </p>
