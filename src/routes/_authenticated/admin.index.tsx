...
import { Tabs, TabsContent, TabsList, TabsTrigger } from "@/presentation/domains/8-core-ux-navigation/ui/tabs";
import { adminCreateUser, adminListUsers, adminDeleteUser } from "@/application/use-cases/admin/user-management";
