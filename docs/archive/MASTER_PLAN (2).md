...
| Files Expected         | docs/_, .gitignore, CONTROL/_                                                                                                                                                                    |
...
| Files Expected         | apps/web/_, packages/shared/_, package.json, tsconfig.json, vite.config.ts, tailwind.config.ts                                                                                                         |
...
| Files Expected         | packages/domain/identity/_, packages/domain/learning/_, packages/api/src/routes/auth/_, apps/web/src/pages/auth/_, apps/web/src/pages/learner/*                                                                         |
...
| Files Expected         | apps/web/src/components/whiteboard/_, packages/domain/evidence/_, packages/domain/notes/_, apps/web/src/pages/evidence/_                                                              |
...
| Files Expected         | packages/domain/tutoring/_, packages/domain/session/_, packages/api/src/routes/tutor/_, apps/web/src/pages/tutor/_, packages/domain/communication/*                      |
...
| Files Expected         | packages/ai-gateway/_, packages/domain/ai/_, apps/web/src/components/ai/_, apps/web/src/pages/ai/_                                                                                       |
...
| Files Expected         | packages/domain/simulations/_, apps/web/src/components/simulation/_, apps/web/src/pages/simulation/* |
...
| Files Expected         | packages/lab-runtime/_, packages/domain/lab/_, apps/web/src/components/lab/_, apps/web/src/pages/lab/_                                            |
...
| Files Expected         | packages/domain/institution/_, packages/api/src/routes/institution/_, apps/web/src/pages/institution/*                    |
...
| Files Expected         | packages/domain/commerce/_, packages/domain/entitlements/_, packages/domain/reporting/_, apps/web/src/pages/billing/_, apps/web/src/pages/reports/_, apps/web/src/pages/parent/_ |
...
| Files Expected         | packages/api/src/routes/admin/_, apps/web/src/pages/admin/_, packages/domain/operations/*                               |
...
| Files Expected         | packages/domain/community/_, apps/web/src/pages/community/_, apps/web/src/components/community/* |
...
| Files Expected         | packages/domain/assessment/_, apps/web/src/pages/assessment/_, apps/web/src/components/advanced-lab/*             |
...
| Files Expected         | packages/domain/community/_, packages/domain/institution/_, packages/domain/commerce/*                    |
...
| Files Expected         | packages/shared/performance/_, packages/domain/operations/_                                  |
...
| Files Expected         | packages/domain/community/_, apps/web/src/pages/community/_                                  |
...
| Files Expected         | packages/ai-gateway/_, packages/domain/ai/_                                                            |
...
| Files Expected         | packages/domain/institution/_, packages/domain/commerce/_, infrastructure/*              |
...
| Files Expected         | infrastructure/_, monitoring/_, docs/production/*                                                  |
